...
export const f5OctoBlogPost = withDataLayer(
  withSeo(
    defineType({
      name: 'f5OctoBlogPost',
      title: 'Octo Blog Post',
      type: 'document',
      description: 'Blog posts under the Office of the CTO',
