...
export const f5LeadershipLanding = withDataLayer(
  withSeo(
    defineType({
      name: 'f5LeadershipLanding',
      title: 'Leadership Landing Page',
      type: 'document',
      icon: HomeIcon,
      ...
      preview: {
        ...
        prepare({title}) {
          return {
            title: title || 'F5.com Leadership Landing Page',
            subtitle: 'Configure Leadership page metadata and hero content for F5.com',
          }
        },
      },
    }),
